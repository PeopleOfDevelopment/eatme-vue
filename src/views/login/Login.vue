    ...
    <div class="Login">
        <div class="green-box">
            <div class="b-text1">
                ...
                <p style="float: right; margin-right: 65%; margin-top: 80px; margin-bottom: 0px;">와</p>
                <p style="float: left; margin-top: 15px; margin-right: 55%;">함께하는 환경보호</p>
            </div>
            <div class="b-text2">
                <p style="margin-bottom: 10px;">국내에서 발생하는 음식물쓰레기는 하루 1만 4천여 톤으로,</p>
                <p style="margin-top: 10px; margin-bottom: 10px;">전체 쓰레기 발생량의 28.7%를 차지합니다.</p>
                <p style="margin-top: 10px;">EAT ME를 통해 남겨지는 음식들을 구하고, 함께 환경보호에 참여해주세요.</p>
            </div>
        </div>
        <div class="white-box">
            <div class="l-box1">
            ...
            <Btn btntype="solid" style="width: 52%; margin-top: 20px; text-align: center; padding: 15px;">로그인</Btn>
